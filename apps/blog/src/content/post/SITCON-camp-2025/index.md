...
一開始是部署在 [Zeabur](https://zeabur.com/?referralCode=elvisdragonmao) 上面，把 OSS Planet 的機器綁定上去，但後來因為這台機器週末突然要系統維護所以我們臨時趕快搬去 GCP 使用 Pterodactyl。很明顯感受到 Zeabur 好用很多，比如說 Rollback 以及不中斷更新，但因為翼龍純粹是同樣的 Docker 所以 git pull 重開很快。
