...
這叫做「框架 Kritik（Framework K）」或「國族建構 Kritik」。我們還可以更可怕一點，扯到「身分 Kritik」：

> 「這個辯題本身就有問題，因為它假設了『女性』這個身分是單一且固定的，忽略了跨性別者、非二元性別者等多元身分的存在。這樣的假設再製了性別二元論的壓迫結構。」
...
### 🏳️‍🌈 4. 身分 Kritik（Identity K / Intersectionality K）

> 「我們要推動免費大學」→ 但如果政策沒有考慮跨性別學生面對的歧視，還是不足

「你說的政策根本沒有考慮到我們這些同時是黑人、跨性別、窮人這種複雜身分的人。」

- **核心批判**：傳統政策思維太過單一，只看「經濟」或「安全」，沒有考慮到「交織的身分結構」如\*\*：性別 + 種族 + 階級。
...
Kritik，特別是身分 Kritik，是在辯論中提醒我們「話語就是政治」的重要思辨。它教會我們去挖掘政策論述背後隱藏的價值觀與權力結構。在面對日常議題時，Kritik 的思維也能幫助我們更敏銳地觀察壓迫、反思語言、並為邊緣群體發聲。
