...
header {
	...
	height: 60vh;
	background:
		linear-gradient(to bottom, rgba(17, 55, 126, 0) 0%, rgba(17, 55, 126, 0) 35%, rgba(17, 55, 126, 1) 100%),
		url(https://ithelp.ithome.com.tw/static/2023ironman/img/kv_bg.jpg) no-repeat center;
